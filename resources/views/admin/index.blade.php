          ...
          <div class="flex-grow-1 overflow-hidden">
            ...
            <p class="text-truncate mb-0">
              <span class="text-danger me-2">
                0.01%
                <i
                  class="ri-arrow-right-down-line align-bottom ms-1"
                ></i
              ></span>
              From previous
            </p>
          ...
          <table class="table table-centered table-nowrap mb-0">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <i
                    class="mdi mdi-checkbox-blank-circle text-danger me-1"
                  ></i>
                  Cancel
                </td>
                <td>
              ...
              <tr>
                ...
                <td>
                  <i
                    class="mdi mdi-checkbox-blank-circle text-warning me-1"
                  ></i>
                  Pending
                </td>
                <td>
