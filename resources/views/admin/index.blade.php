                    ...
                    <div class="d-flex text-muted">
                        ...
                        <div class="flex-grow-1 overflow-hidden">
                            ...
                            <p class="text-truncate mb-0"><span class="text-danger me-2"> 0.01% <i
                                        class="ri-arrow-right-down-line align-bottom ms-1"></i></span>
                                From previous</p>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="table table-centered table-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <img src="/images/users/avatar-2.jpg" alt="user"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="/images/users/avatar-3.jpg" alt="user"
                                            class="avatar-xs rounded-circle" />
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="/images/users/avatar-6.jpg" alt="user"
                                            class="avatar-xs rounded-circle" />
                                    </td>
                                    <td>
